...
CREATE TABLE `historico` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `id_agendamento` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_historico_agendamentos` (`id_agendamento`),
  CONSTRAINT `fk_historico_agendamentos` FOREIGN KEY (`id_agendamento`) REFERENCES `agendamentos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-27 23:46:57
